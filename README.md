# Gatsby/Netlify/Netlify CMS starter
...
An opinionated starter project for creating lightning-fast websites with [Gatsby](https://gatsbyjs.org) v2 and [Netlify CMS](https://netlifycms.org) v2. Original Made by [Thrive Web Design on the Gold Coast, Australia](https://thriveweb.com.au) 
